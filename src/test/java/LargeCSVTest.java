...
public class LargeCSVTest {
    ...
    @Test
    public void testAdditionToSet() {

    }

    @Test
    public void testProcessingLines() {

    }

    @Test
    public void testEmptyFile() throws IOException {
        CSVProcessor processor = new CSVProcessor("/home/olesya/IdeaProjects/LargeCSVTestTask/src/main/resources/emptyTest.csv", 3);
        processor.process();
    ...
    public void testStandardFile() throws IOException {
        List<String> values = Arrays
                .asList("14, 2.41, 0.058, 22",
                        ...
                        "3, 0.98, 0.087, 180",
                        "8, 3.43, 0.204, 192");
        CSVProcessor processor = new CSVProcessor("/home/olesya/IdeaProjects/LargeCSVTestTask/src/main/resources/smallTest.csv", 3);
        processor.process();
    ...
    public void testEqualMarks() throws IOException {
        List<String> values = Arrays
                .asList("14, 2.41, 0.058, 22",
                        ...
                        "3, 0.98, 0.087, 180",
                        "8, 3.43, 0.204, 180");
        CSVProcessor processor = new CSVProcessor("/home/olesya/IdeaProjects/LargeCSVTestTask/src/main/resources/equalTest.csv", 3);
        processor.process();
        Assertions.assertEquals(getCheckList(values), getCheckList(new ArrayList<>(processor.getValues())));
    }
